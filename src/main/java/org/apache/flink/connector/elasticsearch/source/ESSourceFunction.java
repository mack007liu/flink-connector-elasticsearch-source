...
public class ESSourceFunction extends RichParallelSourceFunction<RowData> implements ResultTypeQueryable<RowData> {
    ...
    private static final long serialVersionUID = 2076620098435455721L;
    ...
    public void initClient() throws Exception {
        ...
        credentialsProvider.setCredentials(
                org.apache.http.auth.AuthScope.ANY, new org.apache.http.auth.UsernamePasswordCredentials(username, password));
